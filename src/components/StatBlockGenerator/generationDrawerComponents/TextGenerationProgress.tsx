/**
 * Text Generation Progress Component
 * 
 * Displays animated progress bar with stage-based feedback during text generation.
...
import { COMPLEXITY_TIMINGS, getEstimatedTime } from '../../../constants/textGenerationTiming';

interface TextGenerationProgressProps {
    complexity: string;
    startTime: number;
}

export const TextGenerationProgress: React.FC<TextGenerationProgressProps> = ({
    complexity,
    startTime
}) => {
